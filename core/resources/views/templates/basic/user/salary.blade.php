        ...
        <div class="page-wraper">
                        ...
                        @foreach ($tasks as $task)
                            ...
                            <div class="mission-card">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/app/img/recharge.png') }}"
                                        style="width: 35px;margin-top: -22px;">

                                    <p class="ms-3 reward-title">
                                        Invite {{ $task->referral_count }} to Invest &amp; get
                                        {{ $general->cur_sym }}{{ $task->reward_amount }} </p>
                                </div>
                                <div class="progress-section">
                                    <p class="mb-0">
                                        Invited
                                        {{ $referralsCount >= $task->referral_count ? $task->referral_count : $referralsCount }}/{{ $task->referral_count }}
                                    </p>
                                    <button @if(!$canClaim) disabled @endif class="btn Claim-btn btn-primary btn-sm"
            ...
            <style>
                ...
                .mission-card {
                    ...
                    color: #058c43;
                    background: #ffffff;
                    box-shadow: 0px 4px 10px #8c8c8c41 !important;
                }
