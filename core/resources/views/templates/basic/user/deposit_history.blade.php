                    ...
                    <div class="container">
                        <div class="header-content">
                            ...
                            <div class="mid-content">
                                <h5 class="mb-0">Recharge Records</h5>
                            </div>
                            ...
                            <div class="card transaction-card success shadow-sm">
                                <div class="card-body position-relative p-3 py-2">
                                    ...
                                    @elseif ($data->status == 2)
                                        <div class="position-absolute badge bg-warning"
                                            style="font-size: 9px; right:0; top:0; border-radius: 0px 8px 0px 8px;">
                                            Processing </div>
                                    @else
                                    ...
                                    <div class="d-flex justify-content-between align-items-end">
                                        <div>
                                            <span class="card-title mb-1"
                                                style="font-size: 16px;font-weight:bold;color: black;">{{ $data->trx }}</span>
                                        ...
                                        <div>
                                            ...
                                            @if ($data->status == 1)
                                                <h6 class="mt-0 mb-0 text-success"
                                                    style="font-size: 22px; font-weight: bold;">
                                                    {{ $general->cur_sym }}{{ number_format($data->amount) }}</h6>
                                            @elseif ($data->status == 2)
                                                <h6 class="mt-0 mb-0 text-warning"
                                                    style="font-size: 22px; font-weight: bold;">
                                                    {{ $general->cur_sym }}{{ number_format($data->amount) }}</h6>
                                            @else
                                                <h6 class="mt-0 mb-0 text-danger"
                                                    style="font-size: 22px; font-weight: bold;">
                                                    {{ $general->cur_sym }}{{ number_format($data->amount) }}</h6>
                                            @endif
