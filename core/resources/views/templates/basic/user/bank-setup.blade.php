                        ...
                        <div class="modal-body pt-0">
                            <form action="" method="POST">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select class="form-select rounded border border-2 border-primary" name="bank_code"
                                ...
                                <div class="form-group mt-2">
                                    <label class="mb-1">Account Number</label>
                                    <input class="form-control rounded border border-2 border-primary"
                                        name="account_number"
                                        id="account" placeholder="Account Number"
                                        required="">
                                </div>

                                <div class="form-group mt-2">
                                    <label class="mb-1">Holder Name</label>
                                    <input class="form-control rounded border border-2 border-primary"
                                        name="account_name" id="account_name" placeholder="Account Holder Name"
                                        required="">
                                </div>

                                <button id="bank_button" type="submit"
                                    class="mt-3 btn rounded btn-primary p-2 float-end"
                                    style="background:#058c43;padding: 16px !important;font-size: 131% !important;width: 100%;margin-left: 0px;border-color: #ffffff40;font-weight: 700;border-radius: 18px ! important;">Submit</button>
                            </form>
