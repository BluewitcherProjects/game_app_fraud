        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item">
                    <a href="{{ route('admin.password.code') }}" class="nav-link">
                        <i class="menu-icon las la-lock"></i>
                        <span class="menu-title">Gift Code</span>
                    </a>
                </li>

                <li class="sidebar-menu-item">
                    <a href="{{ route('admin.invite.task') }}" class="nav-link">
                        <i class="menu-icon las la-restroom"></i>
                        <span class="menu-title">Invite Task</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.robot')}}">
                    <a href="{{route('admin.robot')}}" class="nav-link ">
                        <i class="menu-icon las la-link"></i>
                        <span class="menu-title">@lang('Fake Robot')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.proof.index')}}">
                    <a href="{{route('admin.proof.index')}}" class="nav-link ">
                        <i class="menu-icon la la-newspaper"></i>
                        <span class="menu-title">@lang('Manage Blog') </span> 
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.report*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive(['admin.report.plan.invest.log'])}}">
                                <a href="{{route('admin.report.plan.invest.log')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Investment Log')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive(['admin.setting*', 'admin.seo*', 'admin.extensions*', 'admin.language*'],3)}}">
                        <i class="menu-icon la la-cog"></i>
                        <span class="menu-title">@lang('Basic') </span>
                    </a>
                    <div class="sidebar-submenu {{menuActive(['admin.setting*', 'admin.seo*', 'admin.extensions*', 'admin.language*'],2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.extensions.index')}}">
                                <a href="{{route('admin.extensions.index')}}" class="nav-link">
                                    <i class="menu-icon lab la-rocketchat"></i>
                                    <span class="menu-title">@lang('Live Chat Setup')</span>
                                </a>
                            </li>
