                    ...
                    @if($deposit->status == 2)
                        <div class="row mt-4">
                            <div class="col-md-12">
                                ...
                                <form action="{{ route('admin.deposit.reject')}}" method="POST" onsubmit="return confirm('Are you sure?')">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $deposit->id }}">
                                    ...
                                    <button type="submit"  name="block" value="1" class="btn btn--danger">@lang('Reject and Block')</button>
                                </form>
